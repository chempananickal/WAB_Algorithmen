...
A \acrshort{sa} is an array of integers that represent the starting positions of the suffixes of a string in lexicographical order,
...
even though they both fundamentally solve the same problem using the same underlying principle of representing the suffixes of a string in a compact way.
