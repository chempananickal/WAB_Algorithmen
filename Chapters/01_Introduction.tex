...
The same automaton can therefore be used to find the \acrshort{lcs} of the first string and any number of other strings,
without having to reconstruct it every time.
...
\begin{quote}
  How do the \acrshort{sam} and the \acrshort{esa} compare in terms of time and space complexity when solving the \acrlong{lcs} problem \textbf{between two strings} in an everyday programming context?
\end{quote}
