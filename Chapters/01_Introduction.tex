...
by concatenating the strings together with unique delimiters (sentinels), and then constructing the \acrshort{esa} for the concatenated string.
...
as the obtuse memory management of languages like Python\cite{python} could potentially lead to real-world results not matching up with theoretical expectations, especially when it comes to space usage.
